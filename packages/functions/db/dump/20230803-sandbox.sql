...
public,agreement_acceptance,id,bigint,NO,NULL
public,agreement_acceptance,created_at,timestamp with time zone,NO,now()
public,agreement_acceptance,accepted_at,timestamp with time zone,NO,NULL
public,agreement_acceptance,type,text,NO,NULL
public,agreement_acceptance,provider_id,bigint,YES,NULL
public,agreement_acceptance,driver_id,bigint,YES,NULL
public,agreement_acceptance,document_published_at,timestamp with time zone,NO,NULL
public,agreement_acceptance,document_title,text,NO,NULL
public,agreement_acceptance,document_type,text,NO,NULL
public,agreement_acceptance,document_revision_no,integer,NO,NULL
public,agreement_acceptance,legal_document_id,bigint,NO,NULL
public,agreement_acceptance,legal_document_type_id,bigint,NO,NULL
public,agreement_acceptance,location,point,YES,NULL
public,agreement_acceptance,device_ip_address,text,NO,NULL
public,agreement_acceptance,device_system_version,text,NO,NULL
public,agreement_acceptance,device_system_name,text,NO,NULL
...
public,geography_columns,f_table_catalog,name,YES,NULL
public,geography_columns,f_table_schema,name,YES,NULL
public,geography_columns,f_table_name,name,YES,NULL
public,geography_columns,f_geography_column,name,YES,NULL
public,geography_columns,coord_dimension,integer,YES,NULL
public,geography_columns,srid,integer,YES,NULL
public,geography_columns,type,text,YES,NULL
public,geometry_columns,f_table_catalog,character varying,YES,NULL
public,geometry_columns,f_table_schema,name,YES,NULL
public,geometry_columns,f_table_name,name,YES,NULL
public,geometry_columns,f_geometry_column,name,YES,NULL
public,geometry_columns,coord_dimension,integer,YES,NULL
public,geometry_columns,srid,integer,YES,NULL
public,geometry_columns,type,character varying,YES,NULL
...
public,job_mapping_temp,job_new_id,bigint,YES,NULL
public,job_mapping_temp,job_old_id,integer,YES,NULL
...
public,job_table,payment_sum,numeric,YES,0
...
public,legal_document_version,id,bigint,NO,nextval('legal_document_version_id_seq'::regclass)
public,legal_document_version,legal_document_id,bigint,NO,NULL
public,legal_document_version,created_by,character varying,NO,NULL
public,legal_document_version,created_at,timestamp with time zone,NO,now()
public,legal_document_version,updated_by,character varying,YES,NULL
public,legal_document_version,updated_at,timestamp with time zone,YES,NULL
public,legal_document_version,revision_no,integer,NO,NULL
public,legal_document_version,published_at,timestamp with time zone,NO,NULL
public,legal_document_version,s3_key,text,NO,NULL
public,legal_document_version,contentful_id,bigint,NO,NULL
public,legal_document_version,contentful_content_type,bigint,NO,NULL
...
public,spatial_ref_sys,srid,integer,NO,NULL
public,spatial_ref_sys,auth_name,character varying,YES,NULL
public,spatial_ref_sys,auth_srid,integer,YES,NULL
public,spatial_ref_sys,srtext,character varying,YES,NULL
public,spatial_ref_sys,proj4text,character varying,YES,NULL
